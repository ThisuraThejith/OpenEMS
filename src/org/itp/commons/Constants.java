...
public class Constants {
    ...
    public static String REPORT_LOCATION = FILE_LOCATION + File.separator + Calendar.getInstance().get(Calendar.YEAR) + File.separator + Calendar.getInstance().get(Calendar.MONTH);
